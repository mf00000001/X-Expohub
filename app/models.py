...
class User(Base):
    ...
    role: Mapped[UserRole] = mapped_column(
        ...
        index=True, comment="角色：visitor/exhibitor/boss/organizer"
    )
    ...
    company: Mapped[Optional[str]] = mapped_column(
        String(200), nullable=True, comment="公司/机构名称（展商/主办方用）"
    )
